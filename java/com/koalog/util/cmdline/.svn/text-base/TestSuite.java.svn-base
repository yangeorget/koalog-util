...
/**
 * Runs all the tests of the cmdline package.
 * @author Yan Georget
 */
public class TestSuite extends junit.framework.TestSuite {
    ...
    public TestSuite(String name) {
        super(name);
        addTestSuite(CommandLineParserTest.class);
        addTestSuite(DefaultCommandLineParserTest.class);
    }
 ...
 * fixed style
 *
 * Revision 1.2  2002/09/16 07:53:01  yan
 * *** empty log message ***
 *
